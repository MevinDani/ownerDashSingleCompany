...
const DeliveryOrderPending = () => {
        ...
        if (targetDeptNo === 'all') {
            ...
            const fetchData = async () => {
                try {
                    ...
                    const result = await fetch(`https://api-eproc.premierauto.ae/api/DeliveryOrderReport/DoReport/DOPending?dateStart=${formattedDate}&dateEnd=${formattedDate}`)
    ...
    const searchGrp = async () => {
        ...
        setWarningMsg("Resource Loading, Please Wait...")
        try {
            const result = await fetch(`https://api-eproc.premierauto.ae/api/DeliveryOrderReport/DoReport/DOPending?dateStart=${fromDate}&dateEnd=${toDate}`)
            const data = await result.json()
            if (data) {
                setAllData(data);
                setDisplayData(data);
    ...
    return (
        <div className='DelOContainer'>
            ...
            <div className='grpDateCont'>
                <div className='grpSdText'><span><>Delivery Order Pending</></span></div>
...
export default DeliveryOrderPending