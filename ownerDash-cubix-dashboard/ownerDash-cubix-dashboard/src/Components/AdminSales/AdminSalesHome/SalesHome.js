        ...
        <>
            ...
            <div className='SalesHomeWrapper'>
                ...
                <div className='SalesHomeCont'>
                    ...
                    <div className='SalesHomeHeadText' style={{ fontSize: '18px' }}>Sales Report</div>
                    <hr />
                    {/* <div className='SalesHomeHeadText'>Invoice</div> */}
                    <div className='SalesHomeBoxCont'>
                        <div onClick={() => navigate('/admin/Latest500Invoice')}>Sales Invoice List</div>
                        <div onClick={() => navigate('/admin/CashSales')}>CashSales</div>
                    ...
                    {/* <div className='SalesHomeHeadText'>Outstanding</div>
                    <div className='SalesHomeBoxCont'>
                        <div onClick={() => navigate('/admin/customerOutstanding')}>Customer Outstanding</div>
                    </div>
                    <hr /> */}
                </div>
            </div>
