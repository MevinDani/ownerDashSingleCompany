            ...
            <div className='OverallWrapper'>
                ...
                <div className='DelOContainer itemWiseSalesGrp' style={{ paddingTop: '12px' }}>
                    ...
                    <div className='grpDateCont'>
                        <div className='grpSdText'><span><>Sales Invoice List</></span></div>
                                    ...
                                    <tbody>
                                        {
                                            displayData && displayData.map((g, i) => (
                                                <React.Fragment key={i}>
                                                    ...
                                                    {/* {clickedIndex === i && (
                                                    <td colspan='4' style={{ backgroundColor: 'black', color: 'white' }} className='mobTableDrop'>
                                                        <tr style={{ backgroundColor: 'black', color: 'white' }}>
                                                            <td colSpan={2} style={{ textAlign: 'left', backgroundColor: 'black', color: 'white', fontSize: "16px" }}>Total Amount</td>
                                                            <td colSpan={2} style={{ backgroundColor: 'black', color: 'white', fontSize: "16px" }} className='rAlign'>1000</td>
                                                        </tr>
                                                    </td>
                                                )} */}
...
export default Latest500Invoice