...
const PaymentVoucher = () => {
    ...
    return (
        <div className='SalesInvoiceWrapper'>
            ...
            <div className='SalesInvHead'>Payment Voucher</div>
            ...
            <div className='SalesInvoiceBody'>
                ...
                <div className='SalesInvoiceLeft'>
                    ...
                    <div className='mt-2' style={{ display: "flex", justifyContent: "center" }}>
                        <div class="form-check customCheck w-50">
                    ...
                    <div className='mt-2'>
                        ...
                        <div class="input-group mt-2">
                            ...
                            <input type="text" class="form-control customInp" placeholder="Cash Account" aria-label="Username" aria-describedby="basic-addon1" />
                        </div>
                    </div>
                    ...
                    <div className='mt-2' style={{ fontStyle: "italic", textAlign: "left", color: "black", fontWeight: "bold", borderBottom: "1px solid black" }}>Credit Amount</div>

                    <div className='SI4Inps2Cols PVInp2Cols'>
                        <div className='SI4LeftCont'>
                            <div class="input-group mt-2">
                                {/* <span class="input-group-text inpLeftPanel" id="basic-addon1">Amt.Paid</span> */}
                                <input type="text" class="form-control customInp" placeholder="Amt.Paid" aria-label="Username" aria-describedby="basic-addon1" />
                            </div>
                            <div class="input-group mt-2">
                    ...
                    <div className='SI2InpsLeftandRight PVInpLR'>
                        <div class="input-group mt-2">
                            {/* <span class="input-group-text inpLeftPanel" id="basic-addon1">Total Debit</span> */}
                            <input type="text" class="form-control customInp" placeholder="Total Debit" aria-label="Username" aria-describedby="basic-addon1" />
                        </div>
                        <div class="input-group mt-2">
                            {/* <span class="input-group-text inpLeftPanel" id="basic-addon1">Total Credit</span> */}
                            <input type="text" class="form-control customInp" placeholder="Total Credit" aria-label="Username" aria-describedby="basic-addon1" />
                        </div>
                    </div>
