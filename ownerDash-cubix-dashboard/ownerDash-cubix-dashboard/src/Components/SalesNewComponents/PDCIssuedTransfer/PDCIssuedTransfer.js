...
import './PDCIssuedTransfer.css'

const PDCIssuedTransfer = () => {
    return (
            ...
            <div className='SalesInvoiceBody'>
                ...
                <div className='SalesInvoiceLeft'>
                    ...
                    <div>
                        ...
                        <div class="input-group mt-2">
                            {/* <span class="input-group-text inpLeftPanel" id="basic-addon1">PDC ISSUED                                                                                                                                </span> */}
                            <input type="text" class="form-control customInp" placeholder="PDC ISSUED " aria-label="Username" aria-describedby="basic-addon1" />
                        </div>
                    </div>
...
export default PDCIssuedTransfer