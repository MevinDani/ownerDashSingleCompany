...
const TransferIn = () => {
    ...
    return (
        <div className='SalesInvoiceWrapper'>
            ...
            <div className='SalesInvHead'>Transfer In</div>
                ...
                <div className='SalesInvoiceLeft'>
                    ...
                    <div className='ProductMasterDescSpec'>
                        <div class="input-group" style={{ width: "100%" }}>
                            ...
                            <textarea class="form-control customInp" placeholder='Remarks' aria-label="With textarea"></textarea>
                        </div>
                    </div>

                    <div className='mt-2'>
                        <div class="input-group mb-3">
                            {/* <span class="input-group-text" id="basic-addon1">Source Dept</span> */}
                            <input type="text" class="form-control customInp" placeholder="Source Dept" aria-label="Username" aria-describedby="basic-addon1" />
                        </div>
                    </div>
                    ...
                    <div className='mt-2'>
                        <div class="input-group">
                            ...
                            <select class="form-select customInp" aria-label="Default select example">
                                <option value='aed'>Transfer status</option>
                                <option value='aed' selected>CONFIRM</option>
