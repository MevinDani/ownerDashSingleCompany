        ...
        <div className='SalesInvoiceWrapper'>
            ...
            <div className='SalesInvoiceBody'>
                ...
                <div className='SalesInvoiceLeft'>
                    ...
                    <div className='AgeTopOptions'>
                        <div className='AgeingBox'>
                            <div className='AgeBoxes'>
                                <div className='AgeNum'>30</div>
                                <div className='AgeSpace'></div>
                            </div>
                            <div className='AgeBoxes'>
                                <div className='AgeNum'>60</div>
                                <div className='AgeSpace'></div>
                            </div>
                            <div className='AgeBoxes'>
                                <div className='AgeNum'>90</div>
                                <div className='AgeSpace'></div>
                            </div>
                        </div>
