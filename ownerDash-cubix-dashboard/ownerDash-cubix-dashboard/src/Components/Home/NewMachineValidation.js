...
const NewMachineValidation = () => {
    ...
    const validateCompany = async (company) => {
        ...
        // console.log(data, 'dataValidateCmp')
        ...
        //     setDeviceValidation('INVALID')
        //     navigate('/');
        //     console.log("Company is not validated");
        // }
                    ...
                    <div
                        ...
                        <div class="login-section">
                            <div class="logo clearfix">
                                ...
                                {/* {
                                    displayDeviceValid && isDeviceValidated === '' ? <div style={{ color: 'green' }}>Checking Machine Status<RotatingLines
                                        strokeColor="green"
                                        strokeWidth="5"
...
export default NewMachineValidation
