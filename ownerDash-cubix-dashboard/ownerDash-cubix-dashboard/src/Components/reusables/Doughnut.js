...
import ApexChartD from './ApexChartD';
...
const DoughnutChart = () => {
    ...
    const options = {
        ...
        plugins: {
            datalabels: {
                ...
                font: {
                    size: fontSize,
                    padding: 8, // Set the font size as needed
                },
                ...
                rotation: (context) => {
                    ...
                    if (dataValues.length < 4) {
                        return 0; // No rotation if less than 5 values
                    }
                    const minDataValues = dataValues
                        .map((value, index) => ({ value, index }))
                        .sort((a, b) => a.value - b.value)
                        .slice(0, 2)
                        .map(item => item.value);
                    return minDataValues.includes(context.dataset.data[context.dataIndex]) ? -100 : 0;
                },
            },
            legend: {
                display: false,
    ...
    // console.log(isDashItemsPresent, 'isDashItemsPresent')
            ...
            <div className={`DoughnutCont card-dashboard border p-2 rounded ${isDashItemsPresent ? 'wide' : 'wide'}`} style={{ height: "100%" }}>
                ...
                <div className='DFDropItems'>
                    <div className='DFDText'>
                        <div id='TopGrpText'>Top 5 Groups</div>
                    ...
                    <div className='TSMAINDROP' id='DoughMD'>
                        ...
                        {!monthView && !yearView && isOpen && (
                            <div className='TSDropDown'>
                                <div className='TSDropDownCont' id='doughDrops'>
