...
import work_card from "../img/work_card.svg";
import ticket_card from "../img/ticket_card.svg";
import schedule_card from "../img/schedule_card.svg";
import task_card from "../img/task_card.svg";
...
function Home() {
    ...
    const getTaskListApi = () => {
        axios.get(`${process.env.REACT_APP_BASE_URL}/view-task-list-of-user.php?id=${userId}`).then((res) => {
            console.log("res is ", res)
                    ...
                    <div className="name_wrapper position-absolute h-100 w-100 top-0">
                        ...
                        <div className="container pt-4">
                            <div className="d-flex justify-content-center">
                                ...
                                <div className="ms-2">
                                    <div className="image_header">{username}</div>
                ...
                <div className="main_container p-2 container">
...

                    {
                        taskList?.length == 0
                            ?
                            <div >
                                <h5 className="text-center mt-4">No tasks for you</h5>
                                <img className="empty_image" src={ic_no_data_to_show} />
                            </div>
                            :

                            <div className="employee_list_container mt-2">
