...
const LeaveApplication = () => {
  ...
  const [empPopup, setEmpIdPopup] = useState(false);
  ...
  return (
    <div>
      <div className={"leave-allotment container-fluid"}>
        <div className="row">
          <div className="col-md-7">
            <h6 className="mb-2 head-text">Leave Application</h6>
            <div className="row">
            <div className="col-3">
              <input
                type="text"
        ...
        >
          ...
          <LeaveApplicationPopup empPopup={empPopup} />
        </div>
        {records ? (
          <>
