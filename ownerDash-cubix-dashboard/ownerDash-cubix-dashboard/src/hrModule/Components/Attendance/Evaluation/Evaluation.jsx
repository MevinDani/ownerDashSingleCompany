...
import ViewEvaluationpopUp from "./ViewEvaluationpopUp";
...
const Evaluation = () => {
  ...
  return (
    <div className="container-fluid">
            <div className="row">
        <div className="col-6">
        <h6 className="mb-2 head-text">Attendance Evaluation</h6>
        </div>
        <div className="col-6">
    ...
    </div>
{
      ...
      <AttendancePopup popUpData={popUpData}/>
      <ViewEvaluationpopUp popUpData={popUpData} />
